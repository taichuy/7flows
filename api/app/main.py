...
from app.api.routes.published_endpoint_invocation_detail import (
    router as published_endpoint_invocation_detail_router,
)
...
from app.api.routes.workspace_access import router as workspace_access_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(skill_router, prefix="/api")
